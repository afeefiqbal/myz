                ...
                <div class="row g-md-4 g-3">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        ...
                        <div class="footer-contain">
                            <ul>
                                <li>
                                    <a href="products" class="text-content">Vegetables & Fruit</a>
                                </li>
                                <li>
                                    <a href="products" class="text-content">Beverages</a>
                                </li>
                                <li>
                                    <a href="products" class="text-content">Meats & Seafood</a>
                                </li>
                                <li>
                                    <a href="products" class="text-content">Frozen Foods</a>
                                </li>
                                <li>
                                    <a href="products" class="text-content">Biscuits & Snacks</a>
                                </li>
                                <li>
                                    <a href="products" class="text-content">Grocery & Staples</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl col-lg-2 col-sm-3">
                        ...
                        <div class="footer-contain">
                            <ul>
                                ...
                                <li>
                                    <a href="products" class="text-content">Shop</a>
                                </li>
                                <li>
                    ...
                    <div class="col-xl-2 col-sm-3">
                        ...
                        <div class="footer-contain">
                            <ul>
                                <li>
                                    <a href="order-success" class="text-content">Your Order</a>
                                </li>
                                <li>
                                    <a href="user-dashboard" class="text-content">Your Account</a>
                                </li>
                                <li>
                                    <a href="order-tracking" class="text-content">Track Order</a>
                                </li>
                                <li>
                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="https://img.freepik.com/free-photo/modern-laptop-with-blank-white-screen-wooden-table_23-2148029148.jpg?w=996&t=st=1705509154~exp=1705509754~hmac=1b9111a7b461255c5736bf38bd898f42ff00bd3f5206064419797e4fc97d732b" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="right-sidebar-modal">
                                <h4 class="title-name">MacBook Pro Air</h4>
                                ...
                                <div class="modal-button">
                                    <button onclick="location.href = 'cart';"
                                        ...
                                        To Cart</button>
                                    <button onclick="location.href = 'product';"
                        ...
                        <ul class="deal-offer-list">
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="products" class="deal-image">
                                        <img src="assets/images/vegetable/product/10.png" class="blur-up lazyload"
                                            alt="">
                                    </a>

                                    <a href="products" class="deal-contain">
