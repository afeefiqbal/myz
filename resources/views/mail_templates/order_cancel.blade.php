            ...
            <table class="container" width="640" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr align="left" valign="top">
                    <td valign="middle" colspan="5">
                        <p style="font-size:14px;line-height:22px;padding-top:15px;">Dear {{$name}}, <br/><br/></p>
                    </td>
                </tr>
                <tr align="left" valign="top">
                    <td valign="middle" colspan="5">
                        <h2 style="font-size:14px;line-height:22px;padding-top:5px;text-transform:uppercase;"> Order
                            Product cancelled </h2><br/>
                        <br/>
                        <br/>
                        <p><b>Order : ARTMYST#{{$order->order_code}}</b></p>
                ...
                <tr align="left" valign="top">
                    <td valign="middle" colspan="5">
                        <br/>
                        <p style="font-size:14px;line-height:22px;padding-top:15px;">Thanks &
                            Regards<br/>Team {{config('app.name')}}</p>
                        <br/><br/>
                    </td>
                </tr>
                <br/>
