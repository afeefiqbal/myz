                ...
                <form role="form" id="formWizard" class="form--wizard" enctype="multipart/form-data" method="post">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Event Type Form</h3>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control placeholder-cls" id="image_attribute"
                                           ...
                                           value="{{ isset($type)?$type->image_attribute:'' }}">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#image").fileinput({
                ...
                maxFileSize: 512,
                showRemove: true,
                @if(isset($type) && $type->image!=NULL)
                initialPreview: ["{{asset($type->image)}}",],
                initialPreviewConfig: [{
                    caption: "{{last(explode('/',$type->image))}}",
                    width: "120px"
                }]
                @endif
            });
