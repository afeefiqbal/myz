                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{url(Helper::sitePrefix().'product/mount')}}">{{$title}}</a></li>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#image").fileinput({
                ...
                maxFileSize: 512,
                showRemove: true,
                @if(isset($frame) && $mount->image!=NULL)
                initialPreview: ["{{asset($mount->image)}}",],
                initialPreviewConfig: [{
                    caption: "{{ ($shape->image!=NULL)?last(explode('/',$mount->image)):''}}",
                    width: "120px"
                }]
                @endif
            });
