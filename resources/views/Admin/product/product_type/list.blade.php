    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-user-shield"></i> Manage Product Type</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card card-success card-outline">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-hover dataTable">
                                    ...
                                    <tbody>
                                    @foreach($productTypeList as $product_type)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="sort_order"
                                                       ...
                                                       value="{{$product_type->sort_order}}">
                                            </td>
                                            <td>
                                                <label class="switch">
                                                    <input type="checkbox" class="status_check"
                                                           data-url="/status-change" data-table="ProductType"
                                                           data-field="status" data-pk="{{ $product_type->id}}"
                                                        {{($product_type->status=="Active")?'checked':''}}>
                                                    <span class="slider"></span>
                                                </label>
                                            </td>
                                            <td>{{ date("d-M-Y", strtotime($product_type->updated_at))  }}</td>
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{url(Helper::sitePrefix().'product/product-type/edit/'.$product_type->id)}}"
                                                       class="btn btn-success mr-2 tooltips" title="Edit Product Type"><i
