                        ...
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{url(Helper::sitePrefix().'dashboard')}}">Home</a>
                                <li class="breadcrumb-item">
                                    <a href="{{url(Helper::sitePrefix().'product/size')}}">Manage Size</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <span class="caption_note">Note: Image size must be 60 x 60px</span>
                                    @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control placeholder-cls" id="image_attribute"
                                           ...
                                           value="{{ isset($size)?$size->image_attribute:'' }}">
