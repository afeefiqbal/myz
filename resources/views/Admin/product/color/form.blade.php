                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{url(Helper::sitePrefix().'product/color')}}">Manage Colors</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label> Color*</label>
                                    <input type="text" name="title" id="title" placeholder="Color"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="color" name="code" id="code" placeholder="Color Code"
                                           class="form-control required" autocomplete="off" value="{{ @$color->code }}">
