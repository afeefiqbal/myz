                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="fresh-image-2">
                                <div>
                                    <img src="https://myzcomputers.com/wp-content/uploads/2020/04/Picture1-2.png"
                    ...
                    <div class="fresh-contain p-center-left">
                        <div>
                            <div class="review-title">
                                <h4>About Us</h4>
                                <h2>About MYZ Computers LLC.</h2>
                            </div>

                            <div class="delivery-list">
                                <p class="text-content">Since it’s Establishment in October 2008 by Mahboobullah Nayebkhil (Mother Company: MAHBOOB NAIEB KHIL LTD), MYZ Computers LLC has been providing a variety of reliable networking products, toner cartridges (printer consumables) and networking cables to its loyal customers all over The United Arab Emirates, and also exports to the GCC, CIS, African and Asian countries.

                            MYZ Computers LLC is proud to be partners with international companies such as TP-LINK, LINKSYS, ASUS, HUAWEI, and D-LINK.

            MYZ Computers LLC has also developed its own brand of MYZ compatible toner cartridges and networking cables.</p>
