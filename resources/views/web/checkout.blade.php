                    ...
                    <div class="tab-pane" id="p-options" role="tabpanel" aria-labelledby="payment-option">
                                            ...
                                            <div class="accordion-button collapsed" data-bs-toggle="collapse"
                                                ...
                                                <div class="custom-form-check form-check mb-0">
                                                    <label class="form-check-label" for="credit">
                                                        <input  class="form-check-input mt-0 payment_method bank-radio" type="radio"  name="paymentOption" id="online-payment" checked> Credit or
                                                        Debit Card</label>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="accordion-button collapsed" data-bs-toggle="collapse"
                                                ...
                                                <div class="custom-form-check form-check mb-0">
                                                    <label class="form-check-label" for="cash">
                                                        <input class="form-check-input mt-0payment_method" type="radio" id="cod" name="paymentOption" value="COD"> Cash On Delivery</label>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="button-group">
                            <ul class="button-group-list">
                                ...
                                <input type="hidden" value="same" name="billingAddressChoose" id="billingAddressChoose" class="choose">
                                <li>
