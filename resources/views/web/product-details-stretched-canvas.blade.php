...
<section class="productDetailsPage">
    <div class="container">
        <div class="row justify-content-between align-items-start">
            <div class="col-xxl-5  col-lg-5 product_details_gallery stretchedCanvas">
                    ...
                    <div class="priceQuantityArea">
                        ...
                        <div class="quantity_parice_order_area">
                            <div class="quantity-counter">
                                ...
                                <input type="number" disabled class=" qty input-number__input form-control2 form-control-lg" min="1" max="100" step="1" value="1">
            ...
            <div class="modal-body">
                <form action="" method="post" id="bulkenquiryForm" name="bulkenquiryForm">
                    <div class="row">
                        ...
                        <div class="form-group">
                            <input type="text" name="phone" id="phone"class="form-control bulk-streached-phone"
                                placeholder="Phone*">
                        </div>
                        <div class="form-group">
