                    ...
                    <div class=" col-9 productDetailsLeftSecond " >
                        <div class="productDetailsLargeImages">
                            ...
                            @php
                                ...
                                $productType = \App\Models\ProductType::where('id',$productType)->first();
                            @endphp
                            @if(@$productType)
            ...
            <div class="col-xxl-7 col-lg-7 productDetailsInfo ps-xxl-5 ps-xl-4">
                ...
                <div class="productRatingPrice">
                    ...
                    <div class="price">
                        ...
                        @endphp
                        <h5 class="offer_price1">{{Helper::defaultCurrency().' '.number_format(Helper::offerPriceSize($product->id,$firstSizeId,$offerId),2)}}  </h5>
                        @else
                            <h5 class="offer_price1">{{Helper::defaultCurrency().' '.number_format(Helper::defaultCurrencyRate()*$productPrice->price,2)}}</h5>
                            <h5 class="product_price1"></h5>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-lg-6 pe-xl-5">
                <div class="reviewDetailsLeft">
                    <div class="left">
                        ...
                        <div class="my-rating-readonly" data-rating="{{ $averageRatings }}"></div>
                    </div>
                    <div class="right">
            ...
            <div class="modal-body">
                <form action="#" method="post" id="bulkenquiryForm" name="bulkenquiryForm">
                    <div class="row">
                        ...
                        <div class="form-group">
                            <input type="text" name="phone" id="phone"class="form-control bulk-print-phone"
                                placeholder="Phone*">
                        </div>
                        <div class="form-group">
